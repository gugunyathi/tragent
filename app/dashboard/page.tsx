            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <VoiceMic onTranscript={(text) => {
                  ...
                  else if (text.includes("live")) router.push("/");
                }} />
              </div>
            </div>
              ...
              <div className="glass rounded-xl p-4 border border-primary/20">
                ...
                <div className="flex gap-2 mt-2 flex-wrap">
                  {portfolioTokens.map((pos) => (
                    <button key={pos.tokenId} onClick={() => router.push(`/token/${pos.tokenId}`)} className="text-xs glass rounded-lg px-2 py-1 hover:bg-muted text-foreground">
